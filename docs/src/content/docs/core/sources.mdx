...
> In Pulse v3, for complex objects and deep reactivity, it is highly recommended to use the new [`pulse()`](/core/pulse/) API instead of wrapping objects in a `source()`.
